...
assert.equal(canMarkRead('A', { ...base, appRoute: 'other' }), false, 'a non-chat route is not readable');
...
console.log('read-gate OK — exact-visible predicate and per-dialog coalescing');
