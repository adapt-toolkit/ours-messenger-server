...
The suite covers the owned-runtime source boundary, explicit root initialization,
...
`/mcp` 404, receipt semantics, REST/WebPush, SSE backpressure and reconnect,
paging, focused-client contracts and the exact-dialog read gate.
